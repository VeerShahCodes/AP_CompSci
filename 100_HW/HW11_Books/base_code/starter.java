...
class starter {
		...
		*/
		while(true){
			...
			if(choice.equals("file")) {
				...
				System.out.println("What string do you want to check for?");
				String check = sc.nextLine();
				System.out.println("The word " + check + " was found " + checksArray(arr, check) + " times"); //i dont think this works				
			}
	...
	*/
	public static void printsNumber(String[] arr, int num){
		if(num > arr.length) {
			System.out.println("The number inputted is greater than the story length.");
		}
		else {
			for(int i = 0; i < num; i++) {
				System.out.print(arr[i] + " ");
